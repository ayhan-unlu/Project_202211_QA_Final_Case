...
//        js.executeScript("window.scrollTo(0,550)");
  //      Thread.sleep(2000);//waits for 2 second to go to next line of code
        //driver.findElement(By.cssSelector("body.has-searchbox-results.scroll-up:nth-child(7) cx-storefront.stop-navigating.SearchResultsListPageTemplate:nth-child(1) main.mouse-focus:nth-child(6) cx-page-layout.SearchResultsListPageTemplate.ng-star-inserted:nth-child(2) cx-page-slot.SearchResultsListSlot.has-components.ng-star-inserted eb-product-list.ng-star-inserted div.cx-page.ng-star-inserted section.cx-page-section div.container.p-0 div.row.pl-sm-3.pr-sm-1.pr-0.pl-0 div.col-12.col-lg-12.pl-sm-3.pr-sm-3.pr-0.pl-0.ng-star-inserted div.cx-product-container.row.ng-star-inserted div.row.product-list eb-product-list-item.col-6.col-lg-4.col-md-4.col-xl-3.prod-item-col.ng-star-inserted:nth-child(43) div.product-item eb-generic-link.product-item-anchor:nth-child(1) a.product-item-anchor.ng-star-inserted figure.product-item__img.grid-view.ng-star-inserted > cx-media.is-initialized"));

        //driver.findElement(By.xpath("body.has-searchbox-results.scroll-up:nth-child(7) cx-storefront.stop-navigating.SearchResultsListPageTemplate:nth-child(1) main.mouse-focus:nth-child(6) cx-page-layout.SearchResultsListPageTemplate.ng-star-inserted:nth-child(2) cx-page-slot.SearchResultsListSlot.has-components.ng-star-inserted eb-product-list.ng-star-inserted div.cx-page.ng-star-inserted section.cx-page-section div.container.p-0 div.row.pl-sm-3.pr-sm-1.pr-0.pl-0 div.col-12.col-lg-12.pl-sm-3.pr-sm-3.pr-0.pl-0.ng-star-inserted div.cx-product-container.row.ng-star-inserted div.row.product-list eb-product-list-item.col-6.col-lg-4.col-md-4.col-xl-3.prod-item-col.ng-star-inserted:nth-child(43) div.product-item eb-generic-link.product-item-anchor:nth-child(1) a.product-item-anchor.ng-star-inserted figure.product-item__img.grid-view.ng-star-inserted > cx-media.is-initialized")).click();
